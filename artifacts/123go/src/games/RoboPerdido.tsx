      ...
      <div style={{ textAlign: 'center', marginBottom: 12 }}>
        ...
        {phaseData.dualRobot && (
          <div style={{ display: 'flex', gap: 8, justifyContent: 'center', marginTop: 6 }}>
            <button onPointerUp={() => setActiveRobot(0)} style={{
              ...
              fontFamily: 'Nunito', fontWeight: 700, fontSize: 12, cursor: 'pointer', touchAction: 'manipulation',
            }}>
              🤖 Robô 1 {robot1Done ? '✅' : ''}
            </button>
            <button onPointerUp={() => setActiveRobot(1)} style={{
              padding: '6px 14px', borderRadius: 'var(--radius-pill)', border: 'none',
              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    animation: isRobot && isActive && !shaking
